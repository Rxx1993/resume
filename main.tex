...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{\large Strengths}
            \cvtag{Flight Physics \& Control}
            \cvtag{Flight Modelling \& Simulation}
        ...
        \cvsection{Professional Experience}
            ...
            \cvevent{Software Development}{| Phoenix-Wings GmbH}{06.2020 -- 07.2021}{Ismaning, Germany}
            \begin{itemize}
                \item Lead of linearization tool.
        ...
        \cvsection{Projects}
            \cvevent{V280 - 280kg eVTOL}{| TUM-FSD}{02.2020 -- Now}{Industry Project}
            \begin{itemize} \justifying
                \item \textbf{Role}: Lead of control allocation (CA) development
                % \item Major Requirements:
                % % \vspace{1mm}
                % \begin{itemize}
                % \setlength\itemsep{0.1ex}
                \item \textbf{Main Contribution}: Develop CA algorithms for hover, transition and cruise flight, for OEI fail-safe cases.
                \item \textbf{Highlight}: Developed under code-compliant guidelines specified by the DO-331 MBD design process (standard libraries, Model Advisor, Simulink Test Harnesses, and guaranteed WCET on target platform).
            ...
            \cvevent{F-16 Modelling Extension and Control}{| TUM-FSD}{05.2015 -- 07.2017}{Research Project}
            \begin{itemize} \justifying
                \item \textbf{Role}: Lead of simulation model and INDI baseline controller
            ...
            \cvevent{Dragonfish - 5kg Tilt-rotor UAV}{| Autel Robotics Europe GmbH}{06.2016 -- 01.2020}{Industry Project}
            \begin{itemize} \justifying
